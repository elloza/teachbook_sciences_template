...
```{admonition} Consejo
:class: tip
No intentes usar todo a la vez. Empieza con los **ejercicios con solución** (sencillos y compatibles con PDF) y ve añadiendo interactividad según la necesites.
```
